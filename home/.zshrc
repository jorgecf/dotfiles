...
# Path to your oh-my-zsh installation.
  export ZSH=/home/jorgecf/.oh-my-zsh
...
picbackup () {
  rm -rf ~/Desktop/fotografias/.dtrash
  rm -rf /run/media/$DEFAULT_USER/D592-93F6/BACKUP_FOTOS
  mkdir -p /run/media/$DEFAULT_USER/D592-93F6/BACKUP_FOTOS
